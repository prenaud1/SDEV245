...
A secret message about a surprise party is hard-coded near the top.

Each of the following steps waits for any line input (just press enter) before continuing.
...
It is encrypted using Bob's public key. The encrypted message is shown.
